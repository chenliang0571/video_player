...
class AVFoundationVideoPlayerMacOS extends VideoPlayerPlatform {
  final AVFoundationVideoPlayerMacOSApi _api =
      AVFoundationVideoPlayerMacOSApi();

  /// Registers this class as the default instance of [VideoPlayerPlatform].
  static void registerWith() {
    VideoPlayerPlatform.instance = AVFoundationVideoPlayerMacOS();
  }
