...
@interface FLTVideoPlayerPlugin () <FLTAVFoundationVideoPlayerMacOSApi>
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  ...
  FLTAVFoundationVideoPlayerMacOSApiSetup(registrar.messenger, instance);
}
...
- (void)detachFromEngineForRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  ...
  // FLTAVFoundationVideoPlayerMacOSApiSetup(registrar.messenger, nil);
}
...
- (FLTTextureMessage*)create:(FLTCreateMessage*)input error:(FlutterError**)error {
  ...
  // NSLog(@"input.file %@", input.file);
  NSLog(@"input.uri %@", input.uri);
  NSLog(@"input.asset %@", input.asset);
  NSLog(@"input.packageName %@", input.packageName);
  if (input.asset) {
    NSLog(@"input.asset %@ %@", input.asset, input.packageName);
    NSString *assetPath;
    NSString *resourcePath = [NSString stringWithFormat:@"%@/%@", @"/Contents/Frameworks/App.framework/Resources/flutter_assets", input.asset];
    NSLog(@"resourcePath %@", resourcePath);
    // assetPath = Bundle.main.bundlePath + "/Contents/Frameworks/App.framework/Resources/flutter_assets/" + input.asset;
    assetPath = [[NSBundle mainBundle] resourcePath];
