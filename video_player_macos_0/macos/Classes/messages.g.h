...
/// The codec used by FLTAVFoundationVideoPlayerMacOSApi.
NSObject<FlutterMessageCodec> *FLTAVFoundationVideoPlayerMacOSApiGetCodec(void);

@protocol FLTAVFoundationVideoPlayerMacOSApi
...
extern void FLTAVFoundationVideoPlayerMacOSApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTAVFoundationVideoPlayerMacOSApi> *_Nullable api);
